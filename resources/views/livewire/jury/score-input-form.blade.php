    ...
    <div class="row">
        <div class="col-md-6">
            D: <input class="form-control" type="number" step=".1" placeholder="D-score" wire:model="d"
                wire:blur="calculate()" @if ($locked) disabled @endif id="d-score-field"
                tabindex="1" />
            N: <input class="form-control" type="number" step=".1" placeholder="N-score" wire:model="n"
                wire:blur="calculate()" @if ($locked) disabled @endif tabindex="5" />
