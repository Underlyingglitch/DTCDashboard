...
<div>
    ...
    <nav class="navbar fixed-bottom navbar-expand-sm navbar-dark bg-dark d-flex justify-content-between">
        <a class="navbar-brand" href="{{ route('livescores.index') }}">Terug</a>
        ...
        <p class="navbar-brand prevent-select" style="color:#343a40">Terug</p>
        <!-- This is a dummy div to balance the navbar-brand -->
    </nav>
</div>
